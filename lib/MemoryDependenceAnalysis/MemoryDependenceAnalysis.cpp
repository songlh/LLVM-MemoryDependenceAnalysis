...
int NumCacheNonLocal = 0;
int NumCacheDirtyNonLocal = 0;
int NumUncacheNonLocal = 0;
int NumCacheNonLocalPtr = 0;
int NumCacheDirtyNonLocalPtr = 0;
int NumUncacheNonLocalPtr = 0;
int NumCacheCompleteNonLocalPtr = 0;

static const int BlockScanLimit = 100;

char MemoryDependenceAnalysis::ID = 0;

MemoryDependenceAnalysis::MemoryDependenceAnalysis(): PredCache(0)
{
...
bool MemoryDependenceAnalysis::runOnFunction(Function & F) {
  ...
  //remember to update here linhai
  if (!PredCache)
